...
var $author$project$Update$updateFloat = function (value) {
	return A2(
		$elm$core$Maybe$withDefault,
		0,
		$elm$core$String$toFloat(value));
};
var $author$project$Update$updateInt = function (value) {
	return A2(
		$elm$core$Maybe$withDefault,
		0,
...
var $author$project$Msg$AnnualSavings = function (a) {
	return {$: 3, a: a};
};
var $author$project$Msg$CurrentAge = function (a) {
	return {$: 0, a: a};
};
var $author$project$Msg$CurrentSavings = function (a) {
	return {$: 2, a: a};
};
var $author$project$Msg$Inflation = function (a) {
	return {$: 7, a: a};
};
var $author$project$Msg$LifeExpectancy = function (a) {
	return {$: 1, a: a};
};
var $author$project$Msg$RetirementIncome = function (a) {
	return {$: 4, a: a};
};
var $author$project$Msg$SSAIncome = function (a) {
	return {$: 5, a: a};
};
var $author$project$Msg$SSAIncomeStart = function (a) {
	return {$: 6, a: a};
};
var $author$project$Msg$Yield = function (a) {
	return {$: 8, a: a};
};
...
var $author$project$View$inputField = function (field) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('form-floating mb-3')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$for(field.e)
					]),
				_List_fromArray(
					[
...
var $author$project$View$floatField = function (field) {
	return $author$project$View$inputField(
		{
			e: field.e,
			g: field.g,
			h: field.h,
...
var $author$project$View$integerField = function (field) {
	return $author$project$View$inputField(
		{
			e: field.e,
			g: field.g,
...
var $author$project$View$inputForm = function (model) {
	return A2(
		$elm$html$Html$form,
		_List_Nil,
		_List_fromArray(
...
var $author$project$View$retirementAge = function (result) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Estimated Retirement Age:')
					])),
				$elm$html$Html$text(' '),
				$elm$html$Html$text(retirementAgeText)
			]));
};
...
var $author$project$Retirement$simulateYear = F4(
	function (model, retirementAge, age, startingBalance) {
		var yearWithdrawals = A3($author$project$Retirement$withdrawals, model, retirementAge, age);
		var yearSsaIncome = A2($author$project$Retirement$ssaIncome, model, age);
...
var $author$project$Retirement$simulateYears = F3(
	function (model, retirementAge, numYears) {
		var years = (numYears <= 1) ? _List_Nil : A3($author$project$Retirement$simulateYears, model, retirementAge, numYears - 1);
		var _v0 = $elm$core$List$head(years);
		if (!_v0.$) {
			var lastYear = _v0.a;
			return A2(
				$elm$core$List$cons,
				A4($author$project$Retirement$simulateYear, model, retirementAge, lastYear.N + 1, lastYear.J),
				years);
		} else {
			return _List_fromArray(
				[
...
var $author$project$Retirement$simulateWithRetirementAge = F2(
			...
			if (!_v0.$) {
				...
				if (lastYear.J >= 0) {
					...
					var $temp$model = model,
						$temp$retirementAge = retirementAge + 1;
					model = $temp$model;
					retirementAge = $temp$retirementAge;
					continue simulateWithRetirementAge;
				}
			} else {
				return $elm$core$Maybe$Nothing;
			}
...
var $cuducos$elm_format_number$FormatNumber$Stringfy$formatDecimals = F2(
	function (locale, decimals) {
		return (decimals === '') ? '' : _Utils_ap(locale.v, decimals);
	});
var $cuducos$elm_format_number$FormatNumber$Stringfy$stringfy = F2(
	function (locale, formatted) {
		...
		return $elm$core$String$concat(
			_List_fromArray(
				[formatted.K, integers, decimals, formatted.L]));
	});
...
var $author$project$View$yearRow = function (year) {
	return A2(
		$elm$html$Html$tr,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromInt(year.N))
					])),
				A2(
				$elm$html$Html$td,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$View$formatCurrency(year.J))
					]))
			]));
};
var $author$project$View$yearsTable = function (result) {
	var years = function () {
		if (!result.$) {
			var aResult = result.a;
			return aResult.aO;
			...
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Market Change')
							])),
						A2(
						$elm$html$Html$th,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Withdrawals')
							])),
						A2(
						$elm$html$Html$th,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('End Balance')
							]))
					])),
			A2($elm$core$List$map, $author$project$View$yearRow, years)));
};
var $author$project$View$view = function (model) {
	var result = $author$project$Retirement$simulate(model);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Retirement Calculator')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$View$inputForm(model)
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$author$project$View$retirementAge(result),
								$author$project$View$yearsTable(result)
							]))
					]))
			]));
};
